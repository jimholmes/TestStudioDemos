...
namespace DevReachWorkshop
{
    ...
    {
         IWebDriver browser;
         const string CASCADINGURL = "http://www.asp.net/ajaxLibrary/AjaxControlToolkitSampleSite/CascadingDropDown/CascadingDropDown.aspx";
        ...
        public void Implicit_wait_for_element_to_appear()
        {
            ...
            browser.Navigate().GoToUrl(DROPDOWNURL);
            browser.FindElement(
